        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuperiorCategoryId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Categories_Categories_SuperiorCategoryId",
                        column: x => x.SuperiorCategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrefersNetPrice = table.Column<bool>(nullable: false),
                    AcceptsNewsletters = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpertEmail = table.Column<string>(nullable: true),
                    PricePln = table.Column<double>(nullable: false),
                    TaxRate = table.Column<int>(nullable: false),
                    Discount = table.Column<int>(nullable: false),
                    CreatedAt = table.Column<DateTime>(nullable: false),
                    AmountAvailable = table.Column<int>(nullable: false),
                    BoughtTimes = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItems", x => new { x.Id, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_SuperiorCategoryId",
                table: "Categories",
                column: "SuperiorCategoryId");
